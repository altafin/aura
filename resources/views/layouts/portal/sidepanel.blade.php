<div id="app-sidepanel" class="app-sidepanel">
    ...
    <div class="sidepanel-inner d-flex flex-column">
        ...
        <div class="app-branding">
            <a class="app-logo" href="{{ route('dashboard.index') }}"><img class="logo-icon me-2" src="assets/images/app-logo.svg" alt="logo"><span class="logo-text">AURA</span></a>
                ...
                <li class="nav-item has-submenu">
                    ...
                    <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item"><a class="submenu-link" href="{{ route('client.index') }}">Clientes</a></li>
                            <li class="submenu-item"><a class="submenu-link" href="account.html">Fornecedores</a></li>
                            <li class="submenu-item"><a class="submenu-link" href="settings.html">Produtos</a></li>
                        </ul>
                    </div>
                </li><!--//nav-item-->
